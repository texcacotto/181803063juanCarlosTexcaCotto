 ...
 * @author cotto
 */
public class MenuLicenciasV2 extends javax.swing.JFrame {
     ...
     */
    public MenuLicenciasV2() {
        initComponents();
        try {
            this.crearModelo();
        }
        catch (SQLException ex) {
            Logger.getLogger(MenuLicenciasV2.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuLicenciasV2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuLicenciasV2().setVisible(true);
            }
        });
    }
